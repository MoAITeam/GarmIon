...
# curl -X POST -S -H 'Accept: application/json' -H 'Content-Type: multipart/form-data' -F "picId=35" -F "image=R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" http://127.0.0.1:8000/pictures/
